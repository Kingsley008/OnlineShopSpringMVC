...
<#include "/include/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/javawebshop/shop/editSubmit?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt price" name="price"  type="number" min="1" value="${product.price}"/>元
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">数量：</label>
                <div class="fmipt">
                    <input class="u-ipt price" type="number" min="1" name="productnum"/>
                </div>
            </div>
