...
<div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/javawebshop/shop/publicSubmit" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt price" name="price" type="number" min="1"/>元
                </div>
            </div>
            <div class="fmitem">
